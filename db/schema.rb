...
ActiveRecord::Schema[7.0].define(version: 20_220_501_180_237) do
  ...
  create_table 'votes', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[user_id voteable_id voteable_type],
            name: 'index_votes_on_user_id_and_voteable_id_and_voteable_type', unique: true
